...
Circuitos Integrados de Potencia (Power Integrated Circuits), que son dispositivos electrónicos que combinan componentes de control y potencia en un solo chip para gestionar y distribuir la energía eléctrica de manera eficiente

<img src="7_ic_power/image/ic_power.png" alt="ic_power" style="height: 800px; margin: 0 auto 4rem auto; background: transparent; box-shadow: 0 0 10px 10px rgb(150, 156, 238); border-radius: 20px;">
