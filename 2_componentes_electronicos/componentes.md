...
<img src="img/componentes/com_1.png" alt="Componentes" style="height: 800px; margin: 0 auto 4rem auto; background: transparent; box-shadow: 0 0 10px 10px rgb(150, 156, 238); border-radius: 20px;">

---

#### ⚡ Resistencia - Corriente - Voltaje

<img src="img/componentes/com_2.png" alt="Circuito con agua" style="height: 800px; margin: 0 auto 4rem auto; background: transparent; box-shadow: 0 0 10px 10px rgb(150, 156, 238); border-radius: 20px;">
...
<div style="flex: 1; font-size: 0.6em; max-height: 800px; max-width: 100%;  overflow-y: auto; padding-left: 10px;">
    <table>
        <thead>
            <tr>
        ...
        <tbody>
            <tr>
                ...
                <td style="vertical-align: middle;">El capacitor presenta una resistencia muy baja o
                    nula entre sus
                    terminales.</td>
            ...
            <tr>
                ...
                <td style="vertical-align: middle;">El capacitor permite el paso de corriente continua.
                </td>
                <td style="vertical-align: middle;">
                    <ul>
                        <li>Deterioro del dieléctrico</li>
            ...
            <tr>
                ...
                <td style="vertical-align: middle;">El capacitor no presenta continuidad entre sus
                    terminales.</td>
                <td style="vertical-align: middle;">
                    <ul>
            ...
            <tr>
                ...
                <td style="vertical-align: middle;">El capacitor pierde su capacidad de almacenar carga
                    con el
                    tiempo.</td>
                <td style="vertical-align: middle;">
                    <ul>
            ...
            <tr>
                ...
                <td style="vertical-align: middle;">El capacitor se calienta excesivamente durante su
                    operación.
                </td>
                <td style="vertical-align: middle;">
                    <ul>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>La bobina se calienta pero no hay corto circuito, aunque puede afectar el
                rendimiento.</td>
            <td>
